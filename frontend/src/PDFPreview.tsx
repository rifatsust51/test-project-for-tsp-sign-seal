...
// import type { UserProfile } from "./App"; // Import type
...
//         redirectUri: window.location.href, // Return here
//       });
//     } catch (error) {
...
//             <button
//               onClick={onBack}
//               className="md:hidden flex items-center gap-2 text-stone-500 hover:text-stone-800 text-sm font-medium"
//             >
//               <span>←</span> Back
//             </button>
...
//                 {isAuthenticated ? "Ready to Sign" : "Authorization Required"}
//               </h3>
//             </div>
...
//                 {isAuthenticated ? "Complete Signature" : "Log in & Sign"}
//               </span>
//             </button>
//           </div>
//         </div>
